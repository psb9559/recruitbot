...
class recruitinfo(models.Model):
	cmp_name = models.CharField(primary_key=True, null=False, max_length=100)
	date = models.CharField(max_length=20)
	recruit_content = models.CharField(max_length=200)

		
class recruitrank(models.Model):
	c_name = models.ForeignKey(recruitinfo, on_delete=models.CASCADE, db_column='cmp_name')
	recruit_view = models.IntegerField(default=0)
	recruit_day = models.IntegerField(default=0)
	recruit_result = models.IntegerField(default=0)
...
class companyinfo(models.Model):
	...
	view_act = models.IntegerField(default=0)
